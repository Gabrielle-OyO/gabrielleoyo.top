...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
        ...
        _gsScope._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function(t, e, i) {
                ...
                r.version = "1.13.1", l.constructor = r, l.kill()._gc = !1, r.killTweensOf = r.killDelayedCallsTo = i.killTweensOf, r.getTweensOf = i.getTweensOf, r.lagSmoothing = i.lagSmoothing, r.ticker = i.ticker, r.render = i.render, l.invalidate = function() { return this._yoyo = this.vars.yoyo === !0, this._repeat = this.vars.repeat || 0, this._repeatDelay = this.vars.repeatDelay || 0, this._uncache(!0), i.prototype.invalidate.call(this) }, l.updateTo = function(t, e) {
                    ...
                    } else if (this._time > 0) { this._initted = !1, this._init(); for (var a, o = 1 / (1 - r), h = this._firstPT; h;) a = h.s + h.c, h.c *= o, h.s = a - h.c, h = h._next }
                    return this
                ...
                var s = function(t) {
                    ...
                    c = function(t, e, i, s) { t._timeline.pause(t._startTime), e && e.apply(s || t._timeline, i || _) },
                    f = function(t) {
                        var e, i = [],
                            s = t.length;
                        for (e = 0; e !== s; i.push(t[e++]));
                ...
                var s = function(e) { t.call(this, e), this._repeat = this.vars.repeat || 0, this._repeatDelay = this.vars.repeatDelay || 0, this._cycle = 0, this._yoyo = this.vars.yoyo === !0, this._dirty = !0 },
                    ...
                    _ = s.prototype = new t;
                return _.constructor = s, _.kill()._gc = !1, s.version = "1.13.1", _.invalidate = function() { return this._yoyo = this.vars.yoyo === !0, this._repeat = this.vars.repeat || 0, this._repeatDelay = this.vars.repeatDelay || 0, this._uncache(!0), t.prototype.invalidate.call(this) }, _.addCallback = function(t, i, s, r) { return this.add(e.delayedCall(0, t, s, r), i) }, _.removeCallback = function(t, e) {
                    if (t)
            ...
            function() {
                var t = 180 / Math.PI,
                    ...
                    m = f.prototype;
                f.bezierThrough = _, f.cubicToQuadratic = o, f._autoCSS = !0, f.quadraticToCubic = function(t, e, i) { return new n(t, (2 * e + t) / 3, (2 * e + i) / 3, i) }, f._cssRegister = function() {
                ...
                }, m._roundProps = function(t, e) { for (var i = this._overwriteProps, s = i.length; --s > -1;)(t[i[s]] || t.bezier || t.bezierThrough) && (this._round[i[s]] = e) }, m._kill = function(t) {
                ...
                var le = function(t, e, i, s) {
                        ...
                        return _ ? r = e ? function(t) {
                            ...
                            else if (s && D.test(t)) { for (f = t.replace(D, "|").split("|"), c = 0; f.length > c; c++) f[c] = r(f[c]); return f.join(",") }
                            ...
                            var e, n, p;
                            if ("number" == typeof t) t += u;
                            else if (s && D.test(t)) { for (n = t.replace(D, "|").split("|"), p = 0; n.length > p; p++) n[p] = r(n[p]); return n.join(",") }
                    ...
                    }, N.CSSPropTween = function(t, e, s, r, a, o, h, l, _, u, p) { this.t = t, this.p = e, this.s = s, this.c = r, this.n = h || e, t instanceof pe || n.push(this.n), this.r = l, this.type = o || 0, _ && (this.pr = _, i = !0), this.b = void 0 === u ? s : u, this.e = void 0 === p ? s + r : p, a && (this._next = a, a._prev = this) }),
                ...
                var me = function(t, e) { e = e || {}, this.p = e.prefix ? V(t) || t : t, o[t] = o[this.p] = this, this.format = e.formatter || le(e.defaultValue, e.color, e.collapsible, e.multi), e.parser && (this.parse = e.parser), this.clrs = e.color, this.multi = e.multi, this.keyword = e.keyword, this.dflt = e.defaultValue, this.pr = e.priority || 0 },
                ...
                }, h.parse = function(t, e, i, s, n, a) { return this.parseComplex(t.style, this.format(W(t, this.p, r, !1, this.dflt)), this.format(e), n, a) }, a.registerSpecialProp = function(t, e, i) { de(t, { parser: function(t, s, r, n, a, o) { var h = new pe(t, r, 0, 0, a, 2, r, !1, i); return h.plugin = o, h.setRatio = e(t, s, n._tween, r), h }, priority: i }) };
                ...
                de("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent", {
                    ...
                    formatter: ee
                }), de("backgroundSize", { defaultValue: "0 0", formatter: ee }), de("perspective", { defaultValue: "0px", prefix: !0 }), de("perspectiveOrigin", { defaultValue: "50% 50%", prefix: !0 }), de("transformStyle", { prefix: !0 }), de("backfaceVisibility", { prefix: !0 }), de("userSelect", { prefix: !0 }), de("margin", { parser: _e("marginTop,marginRight,marginBottom,marginLeft") }), de("padding", { parser: _e("paddingTop,paddingRight,paddingBottom,paddingLeft") }), de("clip", { defaultValue: "rect(0px,0px,0px,0px)", parser: function(t, e, i, s, n, a) { var o, h, l; return 9 > f ? (h = t.currentStyle, l = 8 > f ? " " : ",", o = "rect(" + h.clipTop + l + h.clipRight + l + h.clipBottom + l + h.clipLeft + ")", e = this.format(e).split(",").join(l)) : (o = this.format(W(t, this.p, r, !1, this.dflt)), e = this.format(e)), this.parseComplex(t.style, o, e, n, a) } }), de("textShadow", { defaultValue: "0px 0px 0px #999", color: !0, multi: !0 }), de("autoRound,strictUnits", { parser: function(t, e, i, s, r) { return r } }), de("border", { defaultValue: "0px solid #000", parser: function(t, e, i, s, n, a) { return this.parseComplex(t.style, this.format(W(t, "borderTopWidth", r, !1, "0px") + " " + W(t, "borderTopStyle", r, !1, "solid") + " " + W(t, "borderTopColor", r, !1, "#000")), this.format(e), n, a) }, color: !0, formatter: function(t) { var e = t.split(" "); return e[0] + " " + (e[1] || "solid") + " " + (t.match(he) || ["#000"])[0] } }), de("borderWidth", { parser: _e("borderTopWidth,borderRightWidth,borderBottomWidth,borderLeftWidth") }), de("float,cssFloat,styleFloat", {
                ...
                var Ce = function(t, e) { e && (t.removeProperty ? ("ms" === e.substr(0, 2) && (e = "M" + e.substr(1)), t.removeProperty(e.replace(P, "-$1").toLowerCase())) : t.removeAttribute(e)) },
                    Oe = function(t) {
                ...
                for (de("clearProps", { parser: function(t, e, s, r, n) { return n = new pe(t, s, 0, 0, n, 2), n.setRatio = De, n.e = e, n.pr = -10, n.data = r._tween, i = !0, n } }), h = "bezier,throwProps,physicsProps,physics2D".split(","), fe = h.length; fe--;) ge(h[fe]);
                ...
                }, h._enableTransforms = function(t) { this._transformType = t || 3 === this._transformType ? 3 : 2, this._transform = this._transform || Pe(this._target, r, !0) };
    ...
    function(t, e) {
        ...
        if (!i.TweenLite) {
            ...
            C(), n.play = function(t, e) { return null != t && this.seek(t, e), this.reversed(!1).paused(!1) }, n.pause = function(t, e) { return null != t && this.seek(t, e), this.paused(!0) }, n.resume = function(t, e) { return null != t && this.seek(t, e), this.paused(!1) }, n.seek = function(t, e) { return this.totalTime(Number(t), e !== !1) }, n.restart = function(t, e) { return this.reversed(!1).paused(!1).totalTime(t ? -this._delay : 0, e !== !1, !0) }, n.reverse = function(t, e) { return null != t && this.seek(t || this.totalDuration(), e), this.reversed(!0).paused(!1) }, n.render = function() {}, n.invalidate = function() { return this }, n.isActive = function() {
            ...
            n._init = function() {
                ...
                if (n.startAt) {
                    ...
                    else { i = {}; for (s in n) U[s] && "autoCSS" !== s || (i[s] = n[s]); if (i.overwrite = 0, i.data = "isFromStart", i.lazy = h && n.lazy !== !1, i.immediateRender = h, this._startAt = D.to(this.target, 0, i), h) { if (0 === this._time) return } else this._startAt._init(), this._startAt._enabled(!1) }
                ...
                if ((c(e) || M(e)) && "number" != typeof e[0])
                    ...
                    if (a) { h = t || a, l = t !== s && "all" !== s && t !== a && ("object" != typeof t || !t._tempKill); for (r in h)(n = a[r]) && (n.pg && n.t._kill(h) && (o = !0), n.pg && 0 !== n.t._overwriteProps.length || (n._prev ? n._prev._next = n._next : n === this._firstPT && (this._firstPT = n._next), n._next && (n._next._prev = n._prev), n._next = n._prev = null), delete a[r]), l && (s[r] = 1);!this._firstPT && this._initted && this._enabled(!1, !1) }
                }
                return o
            ...
            if (n = Q.prototype, Q.version = "1.10.1", Q.API = 2, n._firstPT = null, n._addTween = function(t, e, i, s, r, n) {
                    ...
                    return i
                }, Q.activate = function(t) { for (var e = t.length; --e > -1;) t[e].API === Q.API && (F[(new t[e])._propName] = t[e]); return !0 }, d.plugin = function(t) {
...
(function($) {
    (function(b) { if (typeof define === "function" && define.amd) { define(["jquery"], b) } else { b(jQuery) } }(function(g) {
        var e = {},
            f = Math.max,
            h = Math.min;
        e.c = {};
        e.c.d = g(document);
        e.c.t = function(a) { return a.originalEvent.touches.length - 1 };
        e.o = function() {
            var a = this;
            this.o = null;
            this.$ = null;
            ...
            this.run = function() {
                ...
                if (this.$.is("fieldset")) {
                    ...
                    this.$.bind("change blur", function() { a.val(a._validate(a.o.parse(a.$.val()))) })
                }!this.o.displayInput && this.$.hide();
                this.$c = g(document.createElement("canvas")).attr({ width: this.o.width, height: this.o.height });
            ...
            this._validate = function(b) { return (~~(((b < 0) ? -0.5 : 0.5) + (b / this.o.step))) * this.o.step };
            ...
            this.copy = function(b, d) { for (var k in b) { d[k] = b[k] } }
        };
        e.Dial = function() {
            e.o.call(this);
            ...
            this.w2 = null;
            this.PI2 = 2 * Math.PI;
            this.extend = function() { this.o = g.extend({ bgColor: this.$.data("bgcolor") || "#EEEEEE", angleOffset: this.$.data("angleoffset") || 0, angleArc: this.$.data("anglearc") || 360, inline: true }, this.o) };
            this.val = function(b, a) {
                if (null != b) {
                    b = this.o.parse(b);
                    if (a !== false && b != this.v && this.rH && this.rH(b) === false) { return }
            ...
            this.xy2val = function(j, a) {
                ...
                if (this.o.flip) { d = this.angleArc - d - this.PI2 }
                if (this.angleArc != this.PI2 && (d < 0) && (d > -0.5)) { d = 0 } else { if (d < 0) { d += this.PI2 } }
            ...
            this.angle = function(a) { return (a - this.o.min) * this.angleArc / (this.o.max - this.o.min) };
            this.arc = function(b) {
                var d, a;
                b = this.angle(b);
                if (this.o.flip) {
                ...
                return { s: d, e: a, d: this.o.flip && !this.o.cursor }
            };
            this.draw = function() {
                var a = this.g,
                    j = this.arc(this.cv),
        ...
        a.fn.bxSlider = function(aq) {
            ...
            var aB = a(window).width(),
                ...
                ay = function() {
                    ap.settings = a.extend({}, b, aq), ap.settings.slideWidth = parseInt(ap.settings.slideWidth), ap.children = am.children(ap.settings.slideSelector), ap.children.length < ap.settings.minSlides && (ap.settings.minSlides = ap.children.length), ap.children.length < ap.settings.maxSlides && (ap.settings.maxSlides = ap.children.length), ap.settings.randomStart && (ap.settings.startSlide = Math.floor(Math.random() * ap.children.length)), ap.active = { index: ap.settings.startSlide }, ap.carousel = ap.settings.minSlides > 1 || ap.settings.maxSlides > 1, ap.carousel && (ap.settings.preloadImages = "all"), ap.minThreshold = ap.settings.minSlides * ap.settings.slideWidth + (ap.settings.minSlides - 1) * ap.settings.slideMargin, ap.maxThreshold = ap.settings.maxSlides * ap.settings.slideWidth + (ap.settings.maxSlides - 1) * ap.settings.slideMargin, ap.working = !1, ap.controls = {}, ap.interval = null, ap.animProp = "vertical" == ap.settings.mode ? "top" : "left", ap.usingCSS = ap.settings.useCSS && "fade" != ap.settings.mode && function() {
                        ...
                        for (var f in h) { if (void 0 !== g.style[h[f]]) { return ap.cssPrefix = h[f].replace("Perspective", "").toLowerCase(), ap.animProp = "-" + ap.cssPrefix + "-transform", !0 } }
                        return !1
                    }(), "vertical" == ap.settings.mode && (ap.settings.maxSlides = ap.settings.minSlides), am.data("origStyle", am.attr("style")), am.children(ap.settings.slideSelector).each(function() { a(this).data("origStyle", a(this).attr("style")) }), az()
                },
                az = function() { am.wrap('<div class="bx-wrapper"><div class="bx-viewport"></div></div>'), ap.viewport = am.parent(), ap.loader = a('<div class="bx-loading" />'), ap.viewport.prepend(ap.loader), am.css({ width: "horizontal" == ap.settings.mode ? 100 * ap.children.length + 215 + "%" : "auto", position: "relative" }), ap.usingCSS && ap.settings.easing ? am.css("-" + ap.cssPrefix + "-transition-timing-function", ap.settings.easing) : ap.settings.easing || (ap.settings.easing = "swing"), ax(), ap.viewport.css({ width: "100%", overflow: "hidden", position: "relative" }), ap.viewport.parent().css({ maxWidth: ao() }), ap.settings.pager || ap.viewport.parent().css({ margin: "0 auto 0px" }), ap.children.css({ "float": "horizontal" == ap.settings.mode ? "left" : "none", listStyle: "none", position: "relative" }), ap.children.css("width", al()), "horizontal" == ap.settings.mode && ap.settings.slideMargin > 0 && ap.children.css("marginRight", ap.settings.slideMargin), "vertical" == ap.settings.mode && ap.settings.slideMargin > 0 && ap.children.css("marginBottom", ap.settings.slideMargin), "fade" == ap.settings.mode && (ap.children.css({ position: "absolute", zIndex: 0, display: "none" }), ap.children.eq(ap.settings.startSlide).css({ zIndex: ap.settings.slideZIndex, display: "block" })), ap.controls.el = a('<div class="bx-controls" />'), ap.settings.captions && J(), ap.active.last = ap.settings.startSlide == ai() - 1, ap.settings.video && am.fitVids(); var f = ap.children.eq(ap.settings.startSlide); "all" == ap.settings.preloadImages && (f = ap.children), ap.settings.ticker ? ap.settings.pager = !1 : (ap.settings.pager && F(), ap.settings.controls && ae(), ap.settings.auto && ap.settings.autoControls && ac(), (ap.settings.controls || ap.settings.autoControls || ap.settings.pager) && ap.viewport.after(ap.controls.el)), aw(f, av) },
                aw = function(h, f) {
                    var g = h.find("img, iframe").length;
                    if (0 == g) { return f(), void 0 }
                    var k = 0;
                    h.find("img, iframe").each(function() { a(this).one("load", function() {++k == g && f() }).each(function() { this.complete && a(this).load() }) })
                },
                av = function() {
                ...
                ak = function() {
                    var g = 0,
                        f = a();
                    if ("vertical" == ap.settings.mode || ap.settings.adaptiveHeight) { if (ap.carousel) { var h = 1 == ap.settings.moveSlides ? ap.active.index : ap.active.index * ar(); for (f = ap.children.eq(h), i = 1; i <= ap.settings.maxSlides - 1; i++) { f = h + i >= ap.children.length ? f.add(ap.children.eq(i - 1)) : f.add(ap.children.eq(h + i)) } } else { f = ap.children.eq(ap.active.index) } } else { f = ap.children }
                    return "vertical" == ap.settings.mode ? (f.each(function() { g += a(this).outerHeight() }), ap.settings.slideMargin > 0 && (g += ap.settings.slideMargin * (ap.settings.minSlides - 1))) : g = Math.max.apply(Math, f.map(function() { return a(this).outerHeight(!1) }).get()), g
                },
                ao = function() { var f = "100%"; return ap.settings.slideWidth > 0 && (f = "horizontal" == ap.settings.mode ? ap.settings.maxSlides * ap.settings.slideWidth + (ap.settings.maxSlides - 1) * ap.settings.slideMargin : ap.settings.slideWidth), f },
                al = function() {
                ...
                ax = function() {
                    ...
                    if ("horizontal" == ap.settings.mode && ap.settings.slideWidth > 0) {
                        if (ap.viewport.width() < ap.minThreshold) { f = ap.settings.minSlides } else {
                            if (ap.viewport.width() > ap.maxThreshold) { f = ap.settings.maxSlides } else {
                                var g = ap.children.first().width();
                                f = Math.floor(ap.viewport.width() / g)
                            }
                        }
                    } else { "vertical" == ap.settings.mode && (f = ap.settings.minSlides) }
                    return f
                },
                ai = function() { var g = 0; if (ap.settings.moveSlides > 0) { if (ap.settings.infiniteLoop) { g = ap.children.length / ar() } else { for (var h = 0, f = 0; h < ap.children.length;) {++g, h = f + ax(), f += ap.settings.moveSlides <= ax() ? ap.settings.moveSlides : ax() } } } else { g = Math.ceil(ap.children.length / ax()) } return g },
                ...
                ah = function(f) { ap.settings.auto && am.stopAuto(), am.goToNextSlide(), f.preventDefault() },
                ag = function(f) { ap.settings.auto && am.stopAuto(), am.goToPrevSlide(), f.preventDefault() },
                au = function(f) { am.startAuto(), f.preventDefault() },
                R = function(f) { am.stopAuto(), f.preventDefault() },
                aa = function(h) {
                ...
                an = function(g) { var f = ap.children.length; return "short" == ap.settings.pagerType ? (ap.settings.maxSlides > 1 && (f = Math.ceil(ap.children.length / ap.settings.maxSlides)), ap.pagerEl.html(g + 1 + ap.settings.pagerShortSeparator + f), void 0) : (ap.pagerEl.find("a").removeClass("active"), ap.pagerEl.each(function(h, k) { a(k).find("a").eq(g).addClass("active") }), void 0) },
                ad = function() {
                ...
                af = function(f) { ap.settings.autoControlsCombine ? ap.controls.autoEl.html(ap.controls[f]) : (ap.controls.autoEl.find("a").removeClass("active"), ap.controls.autoEl.find("a:not(.bx-" + f + ")").addClass("active")) },
                ...
                ab = function() { ap.settings.autoDelay > 0 ? setTimeout(am.startAuto, ap.settings.autoDelay) : am.startAuto(), ap.settings.autoHover && am.hover(function() { ap.interval && (am.stopAuto(!0), ap.autoPaused = !0) }, function() { ap.autoPaused && (am.startAuto(!0), ap.autoPaused = null) }) },
                U = function() {
                    var g = 0;
                    if ("next" == ap.settings.autoDirection) { am.append(ap.children.clone().addClass("bx-clone")) } else {
                        am.prepend(ap.children.clone().addClass("bx-clone"));
                        var f = ap.children.first().position();
                        g = "horizontal" == ap.settings.mode ? -f.left : -f.top
                    }
                    aA(g, "reset", 0), ap.settings.pager = !1, ap.settings.controls = !1, ap.settings.autoControls = !1, ap.settings.tickerHover && !ap.usingCSS && ap.viewport.hover(function() { am.stop() }, function() {
                        var l = 0;
                        ap.children.each(function() { l += "horizontal" == ap.settings.mode ? a(this).outerWidth(!0) : a(this).outerHeight(!0) });
                ...
                s = function(f) {
                    if (ap.working) { f.preventDefault() } else {
            ...
            return am.goToSlide = function(o, k) {
                if (!ap.working && ap.active.index != o) {
                    if (ap.working = !0, ap.oldIndex = ap.active.index, ap.active.index = 0 > o ? ai() - 1 : o >= ai() ? 0 : o, ap.settings.onSlideBefore(ap.children.eq(ap.active.index), ap.oldIndex, ap.active.index), "next" == k ? ap.settings.onSlideNext(ap.children.eq(ap.active.index), ap.oldIndex, ap.active.index) : "prev" == k && ap.settings.onSlidePrev(ap.children.eq(ap.active.index), ap.oldIndex, ap.active.index), ap.active.last = ap.active.index >= ai() - 1, ap.settings.pager && an(ap.active.index), ap.settings.controls && t(), "fade" == ap.settings.mode) { ap.settings.adaptiveHeight && ap.viewport.height() != ak() && ap.viewport.animate({ height: ak() }, ap.settings.adaptiveHeightSpeed), ap.children.filter(":visible").fadeOut(ap.settings.speed).css({ zIndex: 0 }), ap.children.eq(ap.active.index).css("zIndex", ap.settings.slideZIndex + 1).fadeIn(ap.settings.speed, function() { a(this).css("zIndex", ap.settings.slideZIndex), ad() }) } else {
                        ...
                        if (!ap.settings.infiniteLoop && ap.carousel && ap.active.last) {
                            ...
                            if (ap.carousel && ap.active.last && "prev" == k) {
                                ...
                                if ("next" == k && 0 == ap.active.index) { f = am.find("> .bx-clone").eq(ap.settings.maxSlides).position(), ap.active.last = !1 } else {
                                    if (o >= 0) {
                                        var q = o * ar();
            ...
            }, am.startAuto = function(f) { ap.interval || (ap.interval = setInterval(function() { "next" == ap.settings.autoDirection ? am.goToNextSlide() : am.goToPrevSlide() }, ap.settings.pause), ap.settings.autoControls && 1 != f && af("stop")) }, am.stopAuto = function(f) { ap.interval && (clearInterval(ap.interval), ap.interval = null, ap.settings.autoControls && 1 != f && af("start")) }, am.getCurrentSlide = function() { return ap.active.index }, am.getCurrentSlideElement = function() { return ap.children.eq(ap.active.index) }, am.getSlideCount = function() { return ap.children.length }, am.redrawSlider = function() { ap.children.add(am.find(".bx-clone")).outerWidth(al()), ap.viewport.css("height", ak()), ap.settings.ticker || G(), ap.active.last && (ap.active.index = ai() - 1), ap.active.index >= ai() && (ap.active.last = !0), ap.settings.pager && !ap.settings.pagerCustom && (aj(), an(ap.active.index)) }, am.destroySlider = function() { ap.initialized && (ap.initialized = !1, a(".bx-clone", this).remove(), ap.children.each(function() { void 0 != a(this).data("origStyle") ? a(this).attr("style", a(this).data("origStyle")) : a(this).removeAttr("style") }), void 0 != a(this).data("origStyle") ? this.attr("style", a(this).data("origStyle")) : a(this).removeAttr("style"), a(this).unwrap().unwrap(), ap.controls.el && ap.controls.el.remove(), ap.controls.next && ap.controls.next.remove(), ap.controls.prev && ap.controls.prev.remove(), ap.pagerEl && ap.settings.controls && ap.pagerEl.remove(), a(".bx-caption", this).remove(), ap.controls.autoEl && ap.controls.autoEl.remove(), clearInterval(ap.interval), ap.settings.responsive && a(window).unbind("resize", e)) }, am.reloadSlider = function(f) { void 0 != f && (aq = f), am.destroySlider(), ay() }, ay(), this
        }
    }(jQuery);
    ! function(b) { "function" == typeof define && define.amd ? define(["jquery"], b) : b("object" == typeof exports ? require("jquery") : jQuery) }(function(f) {
        function e(Q, P) {
            function O() { return H.update(), M(), H }

            function N() { C.css(a, H.contentPosition / H.trackRatio), F.css(a, -H.contentPosition), E.css(d, H.trackSize), D.css(d, H.trackSize), C.css(d, H.thumbSize) }

            function M() { z ? G[0].ontouchstart = function(b) { 1 === b.touches.length && (b.stopPropagation(), L(b.touches[0])) } : (C.bind("mousedown", L), D.bind("mousedown", J)), f(window).resize(function() { H.update("relative") }), H.options.wheel && window.addEventListener ? Q[0].addEventListener(y, K, !1) : H.options.wheel && (Q[0].onmousewheel = K) }

            function L(j) { f("body").addClass("noSelect"), B = A ? j.pageX : j.pageY, H.thumbPosition = parseInt(C.css(a), 10) || 0, z ? (document.ontouchmove = function(b) { b.preventDefault(), J(b.touches[0]) }, document.ontouchend = I) : (f(document).bind("mousemove", J), f(document).bind("mouseup", I), C.bind("mouseup", I)) }
            ...
            function I() { f("body").removeClass("noSelect"), f(document).unbind("mousemove", J), f(document).unbind("mouseup", I), C.unbind("mouseup", I), document.ontouchmove = document.ontouchend = null }
        ...
        var h = "tinyscrollbar",
            g = { axis: "y", wheel: !0, wheelSpeed: 40, wheelLock: !0, scrollInvert: !1, trackSize: !1, thumbSize: !1 };
        f.fn[h] = function(a) { return this.each(function() { f.data(this, "plugin_" + h) || f.data(this, "plugin_" + h, new e(f(this), a)) }) }
    });
    (function(t, r, q, A, y) {
        var C = t("<div>")[0],
            w = /url\(["']?(.*?)["']?\)/,
            s = [],
            u = { top: 0, left: 0, bottom: 1, right: 1, center: 0.5 };
        if ("backgroundSize" in C.style && !t.debugBGS) { return }
        t.cssHooks.backgroundSize = {
            set: function(f, d) {
                ...
                if (a) {
                    ...
                    e = t("<div>").css({ position: "absolute", zIndex: -1, top: 0, right: 0, left: 0, bottom: 0, overflow: "hidden" });
                    g = t("<img>").css({ position: "absolute" }).appendTo(e), e.prependTo(f);
                    t.data(f, "bgsImg", g[0]);
                ...
                } else { t.refreshBackground(f) }
            },
            get: function(a) { return t.data(a, "bgsValue") || "" }
        };
        t.cssHooks.backgroundImage = { set: function(b, a) { return t.data(b, "bgsImg") ? t.refreshBackgroundImage(b, a) : a } };
        t.refreshBackgroundDimensions = function(d, f) {
            var g = t(d),
                e = { width: g.innerWidth(), height: g.innerHeight() },
                a = t.data(d, "bgsDim"),
                b = !a || e.width != a.width || e.height != a.height;
            t.data(d, "bgsDim", e);
            if (b && !f) { t.refreshBackground(d) }
        };
        t.refreshBackgroundImage = function(e, d) {
            ...
            if (b) {
                ...
                g.onload = function() {
                    var k = { width: g.width, height: g.height };
        ...
        t.refreshBackground = function(a) {
            ...
            if (g == "contain") {
                if (b > e) {
                    ...
                    d.css({ top: f });
                    if (j != k) { d.css({ width: "100%", height: "auto", left: 0 }) }
                } else {
                    t.data(a, "bgsConstrain", (j = "height"));
                    f = A.floor((m.width - m.height * b) * h[0]);
                    d.css({ left: f });
                    if (j != k) { d.css({ height: "100%", width: "auto", top: 0 }) }
                }
            } else {
                if (g == "cover") {
                    if (b > e) {
        ...
        B = D.special.throttledresize = {
            setup: function() { t(this).on("resize", B.handler) },
            teardown: function() { t(this).off("resize", B.handler) },
        ...
        t(r).on("throttledresize", function() { t(s).each(function() { t.refreshBackgroundDimensions(this) }) })
    ...
    ! function(J) {
        ...
        function M(f, d, j) {
            ...
            if ("A" !== g.tagName.toUpperCase()) { throw "$.fn.pjax or $.pjax.click requires an anchor element" }
            if (!(f.which > 1 || f.metaKey || f.ctrlKey || f.shiftKey || f.altKey || location.protocol !== g.protocol || location.hostname !== g.hostname || g.hash && g.href.replace(g.hash, "") === location.href.replace(location.hash, "") || g.href === location.href + "#" || f.isDefaultPrevented())) {
                var a = { url: g.href, container: J(g).attr("data-pjax"), target: g },
                    b = J.extend({}, a, j),
        ...
        function Q(d, b, g) {
            ...
            var a = { type: f.method.toUpperCase(), url: f.action, data: J(f).serializeArray(), container: J(f).attr("data-pjax"), target: f };
            af(J.extend({}, a, g)), d.preventDefault()
        }

        function af(g) {
            function b(m, l, f) { f || (f = {}), f.relatedTarget = k; var n = J.Event(m, f); return a.trigger(n, l), !n.isDefaultPrevented() }
            ...
            var j;
            g.beforeSend = function(e, f) { return "GET" !== f.type && (f.timeout = 0), e.setRequestHeader("X-PJAX", "true"), e.setRequestHeader("X-PJAX-Container", a.selector), b("pjax:beforeSend", [e, f]) ? (f.timeout > 0 && (j = setTimeout(function() { b("pjax:timeout", [e, g]) && e.abort("timeout") }, f.timeout), f.timeout = 0), void(g.requestUrl = N(f.url).href)) : !1 }, g.complete = function(e, f) { j && clearTimeout(j), b("pjax:complete", [e, f, g]), b("pjax:end", [e, g]) }, g.error = function(f, p, e) {
                var m = G("", f, g),
                ...
                var s = af.state,
                    ...
                    l = G(e, E, g);
                if (t && p && t !== p) { return void X(l.url) }
                if (!l.contents) { return void X(l.url) }
                af.state = { id: g.id || U(), url: l.url, title: l.title, container: a.selector, fragment: g.fragment, timeout: g.timeout }, (g.push || g.replace) && window.history.replaceState(af.state, l.title, l.url);
                try { document.activeElement.blur() } catch (o) {}
                l.title && (document.title = l.title), b("pjax:beforeReplace", [l.contents, g], { state: af.state, previousState: s }), a.html(l.contents);
            ...
            }, af.state || (af.state = { id: U(), url: window.location.href, title: document.title, container: a.selector, fragment: g.fragment, timeout: g.timeout }, window.history.replaceState(af.state, document.title));
            var d = af.xhr;
        ...
        function O(b, a) { var d = { url: window.location.href, push: !1, replace: !0, scrollTo: !1 }; return af(J.extend(d, aa(b, a))) }

        function X(a) { window.history.replaceState(null, "", "#"), window.location.replace(a) }
        ...
        function K(h) {
            ...
            if (f && f.container) {
                if (q && z == f.url) { return }
                if (af.state && af.state.id === f.id) { return }
                var d = J(f.container);
                if (d.length) {
                    var m, j = A[f.id];
                    af.state && (m = af.state.id < f.id ? "forward" : "back", Z(m, af.state.id, d.clone().contents()));
                    var g = J.Event("pjax:popstate", { state: f, direction: m });
                    d.trigger(g);
                    var k = { id: f.id, url: f.url, container: d, push: !1, fragment: f.fragment, timeout: f.timeout, scrollTo: !1 };
                    if (j) {
                        d.trigger("pjax:start", [null, k]), af.state = f, f.title && (document.title = f.title);
                        var b = J.Event("pjax:beforeReplace", { state: f, previousState: a });
        ...
        function ad(f) {
            var d = J.isFunction(f.url) ? f.url() : f.url,
                ...
                b = J("<form>", { method: "GET" === h ? "GET" : "POST", action: d, style: "display:none" });
            "GET" !== h && "POST" !== h && b.append(J("<input>", { type: "hidden", name: "_method", value: h.toLowerCase() }));
            var g = f.data;
            if ("string" == typeof g) {
                J.each(g.split("&"), function(j, a) {
                    var k = a.split("=");
                    b.append(J("<input>", { type: "hidden", name: k[0], value: k[1] }))
                })
            } else { if ("object" == typeof g) { for (key in g) { b.append(J("<input>", { type: "hidden", name: key, value: g[key] })) } } }
            J(document.body).append(b), b.submit()
        }

        function U() { return (new Date).getTime() }

        function H(a) { return a.replace(/\?_pjax=[^&]+&?/, "?").replace(/_pjax=[^&]+&?/, "").replace(/[\?&]$/, "") }

        function N(a) { var b = document.createElement("a"); return b.href = a, b }

        function aa(b, a) { return b && a ? a.container = b : a = J.isPlainObject(b) ? b : { container: b }, a.container && (a.container = ac(a.container)), a }

        function ac(a) { if (a = J(a), a.length) { if ("" !== a.selector && a.context === document) { return a } if (a.attr("id")) { return J("#" + a.attr("id")) } throw "cant get selector for pjax container!" } throw "no pjax container for " + a.selector }

        function Y(a, b) { return a.filter(b).add(a.find(b)) }

        function R(a) { return J.parseHTML(a, document, !0) }
        ...
        function G(h, g, k) {
            ...
            if (b.title = Y(j, "title").last().text(), k.fragment) {
                if ("body" === k.fragment) { var f = d } else { var f = Y(d, k.fragment).first() }
                f.length && (b.contents = f.contents(), b.title || (b.title = f.attr("title") || f.data("title")))
            } else { /<html/i.test(h) || (b.contents = d) }
            return b.contents && (b.contents = b.contents.not(function() { return J(this).is("title") }), b.contents.find("title").remove(), b.scripts = Y(b.contents, "script[src]").remove(), b.contents = b.contents.not(b.scripts)), b.title && (b.title = J.trim(b.title)), b
        }
        ...
        function D(b) {
            if (b) {
                ...
                b.each(function() {
                    var f = this.src,
                        g = a.filter(function() { return this.src === f });
                    if (!g.length) {
        ...
        function W(a, b) { for (A[a] = b, L.push(a); V.length;) { delete A[V.shift()] } for (; L.length > af.defaults.maxCacheLength;) { delete A[L.shift()] } }
        ...
        function F() { return J("meta").filter(function() { var a = J(this).attr("http-equiv"); return a && "X-PJAX-VERSION" === a.toUpperCase() }).attr("content") }

        function B() { J.fn.pjax = ab, J.pjax = af, J.pjax.enable = J.noop, J.pjax.disable = ae, J.pjax.click = M, J.pjax.submit = Q, J.pjax.reload = O, J.pjax.defaults = { timeout: 650, push: !0, replace: !1, type: "GET", dataType: "html", scrollTo: 0, maxCacheLength: 20, version: F }, J(window).on("popstate.pjax", K) }

        function ae() { J.fn.pjax = function() { return this }, J.pjax = ad, J.pjax.enable = B, J.pjax.disable = J.noop, J.pjax.click = J.noop, J.pjax.submit = J.noop, J.pjax.reload = function() { window.location.reload() }, J(window).off("popstate.pjax", K) }
        var q = !0,
    ...
    (function(v, t, y) {
        ...
        var r;
        if (D && x) {
            r = s.placeholder = function() { return this };
            r.input = r.textarea = true
        } else {
            r = s.placeholder = function() {
                var a = this;
                a.filter((D ? "textarea" : ":input") + "[placeholder]").not(".placeholder").bind({ "focus.placeholder": A, "blur.placeholder": w }).data("placeholder-enabled", true).trigger("blur.placeholder");
                return a
            };
            r.input = D;
            r.textarea = x;
            q = { get: function(b) { var d = y(b); var a = d.data("placeholder-password"); if (a) { return a[0].value } return d.data("placeholder-enabled") && d.hasClass("placeholder") ? "" : b.value }, set: function(d, a) { var e = y(d); var b = e.data("placeholder-password"); if (b) { return b[0].value = a } if (!e.data("placeholder-enabled")) { return d.value = a } if (a == "") { d.value = a; if (d != p()) { w.call(d) } } else { if (e.hasClass("placeholder")) { A.call(d, true, a) || (d.value = a) } else { d.value = a } } return e } };
            if (!D) {
                z.input = q;
                B.value = q
            }
            ...
            y(function() {
                y(t).delegate("form", "submit.placeholder", function() {
                    ...
                    setTimeout(function() { a.each(w) }, 10)
                })
            });
            y(v).bind("beforeunload.placeholder", function() { y(".placeholder").each(function() { this.value = "" }) })
        }

        function u(b) {
            var d = {};
            var a = /^jQuery\d+$/;
            y.each(b.attributes, function(e, f) { if (f.specified && !a.test(f.name)) { d[f.name] = f.value } });
            return d
        }
            ...
            if (f.value == "") {
                if (f.type == "password") {
                    if (!b.data("placeholder-textinput")) {
                        try { a = b.clone().attr({ type: "text" }) } catch (e) { a = y("<input>").attr(y.extend(u(this), { type: "text" })) }
                        a.removeAttr("name").data({ "placeholder-password": b, "placeholder-id": d }).bind("focus.placeholder", A);
                        b.data({ "placeholder-textinput": a, "placeholder-id": d }).before(a)
                    }
        ...
        function p() { try { return t.activeElement } catch (a) {} }
    ...
    var audioflag = false;
    var drow_round = { circles: 20, r: 12 };
    var settings = { circles: 30, hue: 0 };
    if (getUA() === "chrome") { var intval = 20; var density = 12 } else { var intval = 40; var density = 18 }
    var range = 10;
    var speed = 100;
    var megane = 130;
    ...
    var cH = imageH;
    var image = new Image();
    // image.src = "http://kenjiendo.com/testsite/wp-content/themes/kenjiendo_v2/img/kenjiendo2.png";
    $(function() {
        getUA();
    ...
    $(window).mousemove(function(a) {
        ...
        if (getUA() === "chrome" || getUA() === "firefox") {
            TweenLite.to($(".prof_top"), 1, { css: { transform: "translateY(" + (cY - half_wH) / 20 + "px)" }, ease: Power4.easeOut });
            TweenLite.to($(".prof_bottom"), 1, { css: { transform: "translateY(" + (cY - half_wH) / 30 + "px)" }, ease: Power4.easeOut })
        }
    });
        ...
        if (richflag) {
            ...
            var d = window.setInterval(function() {
                if (e >= 100) {
                    ...
                    if (getUA() === "firefox") {} else { int_draw_t = setInterval(function() { draw_t() }, intval) }
                    setupParticles()
                } else {
                    if (e < b) {
                        e++;
    ...
    function common() {
        ...
        $(".album_slide_body").bxSlider({ pager: false, nextSelector: ".gotonext", prevSelector: ".gotoprev", nextText: '<img src="' + DIR + '/img/next.png" width="8">', prevText: '<img src="' + DIR + '/img/prev.png" width="8">' });
        if ($(".create_t").length) {
        ...
        if (!$(".subpages").length) {
            if (getUA() === "chrome" || getUA() === "firefox") {
                setCirclePlayer();
                circlelines()
            } else { $("#sound,.circle_control").remove() }
            setdraw_t()
        }
        $(".cover").each(function(a, d) {
            var e = $(this);
            var b = e.data("split");
            e.css({ height: (wH / 100) * b })
        });
        $(window).on("load", function() {
            ...
            $(".cover").each(function(a, b) {
                var d = $(this);
                var e = d.data("src");
                d.css({ "background-size": "cover", "background-image": "url(" + e + ")" })
            });
            lateload();
            if (wW > 800) {
                $("#news_scroll_wrap").tinyscrollbar({ trackSize: 160 });
                $("#footer_scroll_wrap").tinyscrollbar({ trackSize: 160 })
            }
            setSize();
            if (!$(".subpages").length) { setdraw_t() }
        });
    ...
    function commonafter() {
        ...
        $(window).on("resize", function() { setSize(); if (!$(".subpages").length) { setdraw_t() } });
        if (wW > 800) {
            $("#news_scroll_wrap").tinyscrollbar({ trackSize: 160 });
            $("#footer_scroll_wrap").tinyscrollbar({ trackSize: 160 })
        }
    ...
    function setSize() {
        ...
        $("#sound_effect").attr({ width: wW, height: wH })
    }
    ...
    function setCirclePlayer() {
        DIAL.knob({
            ...
            release: function(a) { setTimeout(function() { HTML.removeClass("circle_control_drag") }, 1000) }
        });
    ...
    function audioProgress(d) {
        ...
        if (d < 0) { d = 0 }
        if (d > 100) { d = 100 }
        if (d > 0) { HTML.addClass("circle_control_begin") }
        var b = ((100 - d) / 100) * e;
        circle_bar.css({ strokeDashoffset: b })
    }

    function circlelines() {
        circle_lines.each(function(a, b) {
            var d = $(this);
            d.css({ strokeDashoffset: "0px", "transition-delay": a / 500 + "s" })
        })
    }
    ...
    function isPlaying() { return !audio.paused && !audio.ended && 0 < audio.currentTime }
    ...
    function draw() {
        ...
        for (var e = 0; e < settings.circles; e += 1) {
            f[e] = { magnitude: 0 };
            for (var b = 0; b < (1024 / (e + 1)); b += 1) { f[e].magnitude += a[b] }
    ...
    //         d = f.data;
    //         for (var e = 0; e < cW; e += density) { for (var a = 0; a < cH; a += density) { b = d[((e + (a * cW)) * 4) - 1]; if (b == 255) { particles.push({ x: e, y: a, x0: e, y0: a }) } } }
    //     }
    // }
    ...
    // 滑动边框跟随效果
    var sideoffset = { p1: 503, p2: 903, p3: 1304, p4: 1704, p5: 2504, p6: 2903, p7: 3304, p8: 3703 };
    $(function() {
    ...
    function scrolling() {
        ...
        $(".subheader_mask").css({ background: "rgba(0,0,0," + a + ")" })
    }
    $(function() {
        if (richflag) {
            $(".borders").find("path").each(function(b) {
                ...
                $(this).attr({ "stroke-dasharray": a, "stroke-dashoffset": a })
            })
        }
    });

    // 菜单栏跳转   分享  Google Facebook Twitter
    ...
    // 顶部  尾部
    $(document).on("click", ".sidenav a", function(a) { a.preventDefault(); var b = $(this).data("pos"); if (getUA() === "chrome" || getUA() === "firefox") { TweenLite.to(window, 1, { scrollTo: { y: b, x: 0 }, ease: Power4.easeOut }) } else { $("body,html").animate({ scrollTop: b }, 500) } });
    $(document).on("click", ".gotobottom", function(a) {
        a.preventDefault();
        var b = $("#footer").offset().top;
        HTML.removeClass("toggled");
        if (getUA() === "chrome" || getUA() === "firefox") { TweenLite.to(window, 3, { scrollTo: { y: b, x: 0 }, ease: Power4.easeOut }) } else { $("body,html").animate({ scrollTop: b }, 500) }
    });
    $(document).on("click", ".gototop", function(a) { a.preventDefault(); if (getUA() === "chrome" || getUA() === "firefox") { TweenLite.to(window, 3, { scrollTo: { y: 0, x: 0 }, ease: Power4.easeOut }) } else { $("body,html").animate({ scrollTop: 0 }, 500) } });
    ...
    function getUA() { var b = window.navigator.userAgent.toLowerCase(); var a = window.navigator.appVersion.toLowerCase(); if (b.indexOf("msie") > -1) { if (a.indexOf("msie 6.0") > -1) { return "ie ie6" } else { if (a.indexOf("msie 7.0") > -1) { richflag = false; return "ie ie7" } else { if (a.indexOf("msie 8.0") > -1) { richflag = false; return "ie ie8" } else { if (a.indexOf("msie 9.0") > -1) { richflag = true; return "ie ie9" } else { if (a.indexOf("msie 10.0") > -1) { richflag = true; return "ie ie10" } else { richflag = true; return "ie" } } } } } } else { if (a.indexOf("trident/7.0") > -1) { richflag = true; return "ie ie11" } else { if (b.indexOf("firefox") > -1) { richflag = true; return "firefox" } else { if (b.indexOf("opera") > -1) { richflag = true; return "opera" } else { if (b.indexOf("chrome") > -1) { richflag = true; return "chrome" } else { if (b.indexOf("safari") > -1) { richflag = true; return "safari" } else {} } } } } } }
    $(document).on("pjax:success", function() {
        ga("set", "location", window.location.href);
        ga("send", "pageview")
    });
    $(document).on("pjax:start", function() { HTML.removeClass("toggled") });
    $(document).on("pjax:end", function() {
        getUA();
        $("#loadbody").animate({ opacity: 1 }, 300);
        setSize();
        commonafter();
        setTimeout(function() { $("html").addClass("loaded") }, 300);
        if (!$(".subpages").length) {
            setdraw_t();
            if (getUA() === "firefox") {} else { int_draw_t = setInterval(function() { draw_t() }, intval) }
            if (getUA() === "chrome" || getUA() === "firefox") {} else { draw_roundy() }
            setTimeout(function() { setupParticles() }, 1000);
            $("html").removeClass("nowonsubpages")
        } else { setTimeout(function() { $("html").addClass("nowonsubpages") }, 300) }
        $(".borders").find("path").each(function(b) {
            var e = this;
            var a = e.getTotalLength();
            var d = e.getPointAtLength(0);
    ...
    $(document).on("click", "a[data-pjax],.pjx,.pjx_wrap a", function(b) {
        ...
        if (b.metaKey || b.ctrlKey) { window.open(this.href); return false }
        var a = $(this).attr("href");
        $("#loadbody").animate({ opacity: 0 }, 300, function() { $.pjax({ url: a, container: "#loadbody", fragment: "#loadbody", timeout: 3000 }) })
    });
})(jQuery);